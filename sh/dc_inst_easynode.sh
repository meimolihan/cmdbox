...
# ====================== 【可自定义配置区】 在这里修改所有默认参数 ======================
# 项目标题
DEFAULT_TITLE="EasyNode 远程管理工具 一键部署"

# 部署目录（不传参时的默认路径）
DEFAULT_COMPOSE_DIR="/vol1/1000/compose/easynode"

# 默认访问端口（不传参时使用），映射容器 8082
DEFAULT_PORT="8082"

# 默认容器名称（可自定义）
DEFAULT_CONTAINER_NAME="easynode"
# ====================================================================================
...
deploy_app() {
    ...
    mkdir -p "${COMPOSE_DIR}/easynode/db" || { log_error "目录创建失败"; break_end; return 1; }
