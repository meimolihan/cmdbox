...
# ====================== 【可自定义配置区】 在这里修改所有默认参数 ======================
# 项目标题
DEFAULT_TITLE="PanSou 私人网盘搜索引擎 一键部署"

# 部署目录（不传参时的默认路径）
DEFAULT_COMPOSE_DIR="/vol1/1000/compose/pansou"

# 默认访问端口（不传参时使用）
DEFAULT_PORT="8110"

# 默认容器名称（可自定义）
DEFAULT_CONTAINER_NAME="pansou"
# ====================================================================================
