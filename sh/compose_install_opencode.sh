...
# ====================== 【可自定义配置区】 在这里修改所有默认参数 ======================
# 项目标题
DEFAULT_TITLE="OpenCode 在线代码编辑器 一键部署"

# 部署目录（不传参时的默认路径）
DEFAULT_COMPOSE_DIR="/vol1/1000/compose/opencode"

# 默认访问端口（不传参时使用）
DEFAULT_PORT="3005"

# 默认容器名称（可自定义）
DEFAULT_CONTAINER_NAME="opencode"
# ====================================================================================
...
services:
   ${DEFAULT_CONTAINER_NAME}:
      ...
      # image: ghcr.nju.edu.cn/anomalyco/opencode
