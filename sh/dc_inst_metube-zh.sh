...
# ====================== 【可自定义配置区】 在这里修改所有默认参数 ======================
# 项目标题
DEFAULT_TITLE="MeTube-ZH 中文版视频下载器 一键部署"

# 部署目录（不传参时的默认路径）
DEFAULT_COMPOSE_DIR="/vol1/1000/compose/metube-zh"

# 默认访问端口（不传参时使用）
DEFAULT_PORT="8081"

# 默认容器名称（可自定义）
DEFAULT_CONTAINER_NAME="metube-zh"

# 默认代理地址（留空则不配置代理）
DEFAULT_PROXY="http://10.10.10.252:7893"

# 代理排除列表
DEFAULT_NO_PROXY="localhost,127.0.0.1,172.17.0.0/16"
# ====================================================================================
...
services:
   ${DEFAULT_CONTAINER_NAME}:
      image: mobufan/metube-zh:latest
