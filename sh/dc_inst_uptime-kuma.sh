...
# ====================== 【可自定义配置区】 在这里修改所有默认参数 ======================
DEFAULT_TITLE="Uptime Kuma 监控工具 一键部署"
DEFAULT_COMPOSE_DIR="/vol1/1000/compose/uptime-kuma"
DEFAULT_PORT="3001"
DEFAULT_CONTAINER_NAME="uptime-kuma"
# ====================================================================================
...
handle_invalid_input() {
    echo -e "\r\033[K${gl_hong}输入无效，请重新选择${gl_bai}"
    sleep_fractional 1
    echo -ne "\r\033[K"
    return 2
}
